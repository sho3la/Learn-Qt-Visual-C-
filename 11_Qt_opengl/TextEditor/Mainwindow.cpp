	...
	: QMainWindow(parent) , font_size(10)
{
	...
	QWidget* centr = new QWidget;
	QHBoxLayout* _layout = new QHBoxLayout;


	textarea = new QPlainTextEdit(centr);
	opengl = new openglwidget(centr);

	_layout->addWidget(textarea);
	_layout->addWidget(opengl);

	centr->setLayout(_layout);
